...
#define MyAppName "Gestión | Conversor PDF"
...
LicenseFile=C:\Users\efrenbg1\ownCloud\Proyectos\basa3pdf\LICENSE
; Uncomment the following line to run in non administrative install mode (install for current user only.)
;PrivilegesRequired=lowest
OutputDir=C:\Users\efrenbg1\ownCloud\Proyectos\basa3pdf\msi
OutputBaseFilename=basa2pdf
Compression=lzma
...
[Files]
Source: "C:\Users\efrenbg1\ownCloud\Proyectos\basa3pdf\dist\basa3pdf\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
